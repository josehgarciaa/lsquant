...
g++ -I/usr/include/eigen3 -Ilib/include -shared -o lib/libcell_list.so lib/src/cell_list.cpp -fPIC -O3
g++ -I/usr/include/eigen3 -Ilib/include -Llib/ lib/src/neighbors.cpp -o neighbors -lcell_list -fPIC -O3 
